...
public class CustomerEntryPanel extends JPanel {
    ...
    private void initializeUI() {
        ...
        gbc.gridwidth = 4; gbc.weighty = 0.25;
        ...
        gbc.weightx = 0.6; gbc.weighty = 0.625;
        ...
        gbc.ipady = 20;
        add(createStyledButton("Shopping Cart", new Color(154, 45, 205)), gbc);

        gbc.gridx = 3; gbc.gridy = 7;
        add(createStyledButton("Logout", new Color(170, 150, 89)), gbc);
    }
    ...
    private JComponent createProductScrollPanel() {
        ...
        // Fill with cards
        for (int i = 0; i < 10; i++) {
            CustomerProductView card = new CustomerProductView("Coffee", 300.0, 18, "");
